...
#include "cpp_pkg/srv/odd_even_check.hpp"


typedef cpp_pkg::srv::OddEvenCheck OddEvenCheckSrv;
...
class OddEvenCheckServiceNode : public rclcpp::Node 
{
  public:
    OddEvenCheckServiceNode(): Node("odd_even_check_service_node")
    {
      service_server_ = this->create_service<OddEvenCheckSrv>(
        "odd_even_check",
        std::bind(&OddEvenCheckServiceNode::check_num_odd_even, 
        this,
        std::placeholders::_1, 
        std::placeholders::_2)
      );
  ...
  private:
    ...
    void check_num_odd_even(const OddEvenCheckSrv::Request::SharedPtr request, OddEvenCheckSrv::Response::SharedPtr response) 
    {
